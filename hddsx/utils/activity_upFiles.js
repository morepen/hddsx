...
var getPicArr = t => {
  var pis_str=JSON.stringify(t.data.uploadedPathArr);
  return pis_str;
}
...
var upFilesFun = (t, data, progress, success) => {
  ...
  const uploadTask = wx.uploadFile({
    ...
    complete: function (res) {
      ...
      if (startIndex == filesPath.length - 1) {
        ...
        app.globalData.fileStr = JSON.stringify(sucPathArr);
        success(sucPathArr);
        // t.setData({
        //   uploadedPathArr: []
        // })
  ...
  uploadTask.getPic=function(){
    return t.data.uploadedPathArr;
  }
